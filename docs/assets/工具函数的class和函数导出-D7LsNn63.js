...
</code></pre><blockquote><p>最好 export default 导出 class,而 普通 export 导出函数 这样 导入导出起来也方便,还充分利用了 export default</p></blockquote>`,29)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};
import{E as e,f as t,u as n}from"./runtime-core.esm-bundler-D0V1POjj.js";import{t as r}from"./plugin-vue_export-helper-DmxsexXh.js";var i=JSON.parse(`{"path":"/blogs/%E5%89%8D%E7%AB%AF/%E5%BC%80%E5%8F%91%E6%8A%80%E5%B7%A7/ts%E5%BC%80%E5%8F%91%E6%8A%80%E5%B7%A7/typescript%E4%B8%AD_%E5%AE%9E%E7%8E%B0%E2%80%9D%E7%BB%A7%E6%89%BF%E2%80%9C%E2%80%9D%E8%A6%86%E7%9B%96%E2%80%9C.html","title":"typescript中 &实现”继承“”覆盖“","lang":"zh-CN","frontmatter":{}}`),a={name:`typescript中&实现”继承“”覆盖“.md`};function o(r,i,a,o,s,c){return e(),n(`div`,null,[...i[0]||=[t(`<h1 id="typescript中-实现-继承-覆盖" tabindex="-1"><a class="header-anchor" href="#typescript中-实现-继承-覆盖"><span>typescript中 &amp;实现”继承“”覆盖“</span></a></h1><p>在我们开发ts代码,定义type的时候,所以的type不一定都是独立的,也可能有一些继承关系</p><h2 id="需求-实现-基础数据类型的-继承" tabindex="-1"><a class="header-anchor" href="#需求-实现-基础数据类型的-继承"><span>需求:实现 基础数据类型的 &quot;继承&quot;</span></a></h2><p>我们可能需要基于一些基础数据,进行扩写出不同的数据结构,我们每次写type的时候都将所有的 属性手动书写出来,这样会有许多不同的问题</p><blockquote><p><strong>添加原始数据结构</strong>:我们需要将其扩展类型也同步修改,我们也要一个个修改吗? <strong>修改原始数据结构</strong>:我们需要将其扩展类型也同步修改,我们也要一个个修改吗? <strong>删除原始数据结构</strong>:我们需要将其扩展类型也同步修改,我们也要一个个修改吗?</p></blockquote><pre><code class="language-ts">type ThxStardardHkStockType = {
